...
if (!comp || !(comp instanceof CompItem)) {
    ...
    if (layers.length !== 2) {
        ...
        // Flip positions: A Cam (Right), B Cam (Left)
        bCam.transform.position.setValue([halfWidth / 2, compHeight / 2]); // B Cam on Left
        aCam.transform.position.setValue([halfWidth + halfWidth / 2, compHeight / 2]); // A Cam on Right

        alert("Multicam Split-Screen Fixed: A Cam (Right), B Cam (Left), No Forced Black Bars");
    }
}
